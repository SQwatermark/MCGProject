...
public class RenderGRC2M extends AbsCartRenderer {

    public static IRenderFactory<EntityMinecart> FACTORY = RenderGRC2M::new;
    private final String _name = "grc_2m";
    ...
    public RenderGRC2M(RenderManager manager) {
        super(manager);
    }
