...
public class GuiTCTextField extends Gui {
	...
	private void drawCursorVertical(int par1, int par2, int par3, int par4) {
		...
		bufferBuilder.pos((double) par1, (double) par4, 0.0D);
		bufferBuilder.pos((double) par3, (double) par4, 0.0D);
		bufferBuilder.pos((double) par3, (double) par2, 0.0D);
		bufferBuilder.pos((double) par1, (double) par2, 0.0D);
		tessellator.draw();
