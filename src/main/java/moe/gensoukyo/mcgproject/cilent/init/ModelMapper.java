...
import moe.gensoukyo.mcgproject.common.item.ItemMCGBannerPattern;
import moe.gensoukyo.mcgproject.common.item.ItemMCGDrink;
import moe.gensoukyo.mcgproject.common.item.ItemMCGFood;
...
public class ModelMapper {
    ...
    public void registerModels(ModelRegistryEvent event) {
        ...
        registerModel(ModItem.ITEM_MCG_FOOD, ItemMCGFood.MAX_META);
        registerModel(ModItem.ITEM_MCG_DRINK, ItemMCGDrink.MAX_META);
        registerModel(ModItem.ITEM_MCG_PROP, ItemMCGProp.MAX_META);
        registerModel(ModItem.ITEM_MCG_BANNER_PATTERN, ItemMCGBannerPattern.MAX_META);
