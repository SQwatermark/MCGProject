...
public class BlockTransparent16 extends BlockTransparent {

    public BlockTransparent16(Material materialIn, String registryName, CreativeTabs tab, SoundType soundType) {
