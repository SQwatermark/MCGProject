...
public class BlockInteger12 extends BlockMCG {

    public BlockInteger12(Material materialIn, String registryName, CreativeTabs tab, SoundType soundType)
    {
        super(materialIn, registryName, tab, soundType);
    }

    // add properties
    public static PropertyInteger META = PropertyInteger.create("meta", 0, 11);
