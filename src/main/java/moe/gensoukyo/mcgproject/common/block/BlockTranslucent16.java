...
public class BlockTranslucent16 extends BlockTranslucent {

    public BlockTranslucent16(Material materialIn, String registryName, CreativeTabs tab, SoundType soundType) {
