...
@MCGEntity("grh_2m")
public class GRH2M extends AbsLoco implements IHighSpeedCart {

    private static final DataParameter<Boolean> HIGH = EntityDataManager.createKey(GRH2M.class, DataSerializers.BOOLEAN);

    public GRH2M(World world) {
        this(world, 0, 0, 0);
    }

    public GRH2M(World world, double x, double y, double z) {
        super(world, x, y, z);
        setSize(1.25F, 1.0F);
