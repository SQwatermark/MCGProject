...
public class Networking
{
  ...
  public static void preInitCommon(SimpleNetworkWrapper wrapper, int id)
  {
    netw = wrapper;
    netw.registerMessage(OverlayTextMessage.NetEventHandler.class, OverlayTextMessage.class, id + OverlayTextMessage.MESSAGE_ID, Side.SERVER);
    netw.registerMessage(OverlayTextMessage.NetEventHandler.class, OverlayTextMessage.class, id + OverlayTextMessage.MESSAGE_ID, Side.CLIENT);
  }
