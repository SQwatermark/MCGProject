...
import moe.gensoukyo.mcgproject.common.feature.rsgauges.items.RsItem;
...
//    new BlockSwitch("bistableswitch_rustic6",ModAuxiliaries.getPixeledAABB(0,1,0, 16,15,2), null,RsBlock.RSBLOCK_CONFIG_OBSOLETE|BlockSwitch.SWITCH_CONFIG_BISTABLE|BlockSwitch.SWITCH_CONFIG_WALLMOUNT|BlockSwitch.SWITCH_CONFIG_WEAKABLE|BlockSwitch.SWITCH_CONFIG_INVERTABLE|BlockSwitch.SWITCH_CONFIG_LINK_TARGET_SUPPORT|BlockSwitch.SWITCH_CONFIG_LINK_SOURCE_SUPPORT,null, null),
  ...
  public static final void registerBlocks(RegistryEvent.Register<Block> event)
  {
    ...
    if(gauge_entity_needed) {
      GameRegistry.registerTileEntity(BlockGauge.TileEntityGauge.class, new ResourceLocation(ModRsGauges.RESID, "gauge_entity"));
      ++num_tile_entities;
    }
    if((switch_config_bits_union_set & (BlockSwitch.SWITCH_CONFIG_BISTABLE|BlockSwitch.SWITCH_CONFIG_PULSE|BlockSwitch.SWITCH_CONFIG_LINK_RELAY)) != 0) {
      GameRegistry.registerTileEntity(BlockSwitch.TileEntitySwitch.class, new ResourceLocation(ModRsGauges.RESID, "switch_entity"));
      ++num_tile_entities;
    }
    if((switch_config_bits_union_set & (BlockSwitch.SWITCH_CONFIG_CONTACT)) != 0) {
      GameRegistry.registerTileEntity(BlockContactSwitch.TileEntityContactSwitch.class, new ResourceLocation(ModRsGauges.RESID, "contactswitch_entity"));
      ++num_tile_entities;
    }
    if((switch_config_bits_union_set & (BlockSwitch.SWITCH_CONFIG_AUTOMATIC)) != 0) {
      GameRegistry.registerTileEntity(BlockAutoSwitch.TileEntityAutoSwitch.class, new ResourceLocation(ModRsGauges.RESID, "autoswitch_entity"));
      ++num_tile_entities;
      if((switch_config_bits_union_set & (BlockSwitch.SWITCH_CONFIG_SENSOR_DETECTOR)) != 0) {
        GameRegistry.registerTileEntity(BlockAutoSwitch.TileEntityDetectorSwitch.class, new ResourceLocation(ModRsGauges.RESID, "detectorswitch_entity"));
        ++num_tile_entities;
      }
      if((switch_config_bits_union_set & (BlockSwitch.SWITCH_CONFIG_SENSOR_ENVIRONMENTAL)) != 0) {
        GameRegistry.registerTileEntity(BlockAutoSwitch.TileEntityEnvironmentalSensorSwitch.class, new ResourceLocation(ModRsGauges.RESID, "sensorswitch_entity"));
        ++num_tile_entities;
      }
      if((switch_config_bits_union_set & (BlockSwitch.SWITCH_CONFIG_SENSOR_TIME)) != 0) {
        GameRegistry.registerTileEntity(BlockAutoSwitch.TileEntityIntervalTimerSwitch.class, new ResourceLocation(ModRsGauges.RESID, "timerswitch_entity"));
        ++num_tile_entities;
      }
      if((switch_config_bits_union_set & (BlockSwitch.SWITCH_CONFIG_SENSOR_BLOCKDETECT)) != 0) {
        GameRegistry.registerTileEntity(BlockObserverSwitch.TileEntityObserverSwitch.class, new ResourceLocation(ModRsGauges.RESID, "observerswitch_entity"));
        ++num_tile_entities;
      }
      GameRegistry.registerTileEntity(BlockComparatorSwitch.TileEntityComparatorSwitch.class, new ResourceLocation(ModRsGauges.RESID, "comparatorswitch_entity"));
      ++num_tile_entities;
    }
  ...
  public static final class Colors
  {
    ...
    public static final void registerBlockColourHandlers(final ColorHandlerEvent.Block event)
    {
      ...
      int n = 0;
      for(Block e:registeredBlocks) {
        if((e instanceof ColorTintSupport) && (((ColorTintSupport)e).hasColorMultiplierRGBA())) {
