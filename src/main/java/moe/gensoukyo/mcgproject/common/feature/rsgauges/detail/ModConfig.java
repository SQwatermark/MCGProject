...
public class ModConfig
{
  ...
  public static final class SettingsAFeatureOptout
  {
    ...
    @Config.RequiresMcRestart
    public boolean without_blinking_indicators = true;
    ...
    @Config.RequiresMcRestart
    public boolean without_decorative = true;
  ...
  public static final class SettingsZTesting
  {
    ...
    public int max_switch_linking_distance = 0;
  ...
  private static final class EventHandler
  {
    ...
    public static void onConfigChanged(final ConfigChangedEvent.OnConfigChangedEvent event) {
      if(!event.getModID().equals(ModRsGauges.RESID)) return;
      ConfigManager.sync(ModRsGauges.RESID, Config.Type.INSTANCE);
      update();
    }
  }
  ...
  private static final void update()
  {
    ...
    // patterns
    {
      String inc = optouts.pattern_includes.toLowerCase().replaceAll(ModRsGauges.RESID +":", "").replaceAll("[^*_,a-z0-9]", "");
    ...
    {
      String exc = optouts.pattern_excludes.toLowerCase().replaceAll(ModRsGauges.RESID +":", "").replaceAll("[^*_,a-z0-9]", "");
