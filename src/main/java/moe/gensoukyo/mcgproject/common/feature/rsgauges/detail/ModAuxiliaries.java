...
public class ModAuxiliaries
{
  ...
  {
    TextComponentTranslation tr = new TextComponentTranslation(ModRsGauges.RESID +"."+modtrkey, args);
  ...
  public static final class Tooltip
  {
    ...
    public static boolean addInformation(@Nullable String advancedTooltipTranslationKey, @Nullable String helpTranslationKey, List<String> tooltip, ITooltipFlag flag, boolean addAdvancedTooltipHints)
    {
      ...
      if(helpCondition()) {
        ...
        String s = "";
        if(tip_available) s += localize(ModRsGauges.RESID + ".tooltip.hint.extended") + (help_available ? " " : "");
        if(help_available) s += localize(ModRsGauges.RESID + ".tooltip.hint.help");
        tooltip.add(s);
      }
      return false;
    }
