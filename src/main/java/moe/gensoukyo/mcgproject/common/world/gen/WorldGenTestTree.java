package moe.gensoukyo.mcgproject.common.world.gen;
...
public class WorldGenTestTree extends WorldGenAbstractTree
{
    ...
    List<WorldGenTestTree.FoliageCoordinates> foliageCoords;
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords.add(new WorldGenTestTree.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenTestTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE));
        }
    }
    ...
    void generateLeaves()
    {
        for (WorldGenTestTree.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
